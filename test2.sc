// TODO: .widen where is it?

// libraryDependencies += "org.scalaz" %% "scalaz-core" % "7.2.27"
import $ivy.`org.scalaz::scalaz-core:7.2.27`, scalaz._

// https://alvinalexander.com/java/jwarehouse/scalaz-7.3/example/src/main/scala/scalaz/example/BifunctorUsage.scala.shtml
...
/**
  ...
  * already familiar with. Whereas a Functor operates on a * â†’ * and
  * has a single operation `map` which takes a function from A => B to
  * map a F[A] to a F[B], a Bifunctor operates on a *,* â†’ * and has a
  * single operation `bimap` which takes two functions: A â‡’ C and a
  * B â‡’ D to map a F[A,B] to a F[C,D]:
  *
